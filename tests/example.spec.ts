...
//'43925359404845532092817178379174716572364073241775397277882415244257069130017'
    ...
    await mintology.auth('MDFKMlIxMjk1ODJTQVA0TVlINlBGS1pYNzI6NDg3MDE5Y2E0ZGRlMzk2YTQ2MjFlZDllM2RiZDk2YjMwNTBlZjg2ODk1MzUxOGZiMWMzZTE1YjE5ZDNiMjBlNw');
...
/*  await  mintology.custodialWalletsCreate({email:'playwright-lasantha@1secmail.com'})
 ...
 /*     await mintology.mintMint({
     ...
     await   mintology.authorize({
          token_id: '43925359404845532092817178379174716572364073241775397277882415244257069130017',
          wallet_address: '0x611cdf54c18edd4d6777970b54a4a92b51b70e04',
          email: 'playwright-lasantha@1secmail.com'
        }, {
          projectId: '01J2RDCGZ6T1FKPD39N1H6HCW7'
        })
