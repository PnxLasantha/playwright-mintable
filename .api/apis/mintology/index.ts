...
class SDK {
   ...
   */
  authorize(body: types.AuthorizeBodyParam, metadata: types.AuthorizeMetadataParam): Promise<FetchResponse<200, types.AuthorizeResponse200>> {
   ...
   */
  authorizeInventory(body: types.AuthorizeInventoryBodyParam, metadata: types.AuthorizeInventoryMetadataParam): Promise<FetchResponse<200, types.AuthorizeInventoryResponse200>>;
  authorizeInventory(metadata: types.AuthorizeInventoryMetadataParam): Promise<FetchResponse<200, types.AuthorizeInventoryResponse200>>;
  authorizeInventory(body?: types.AuthorizeInventoryBodyParam | types.AuthorizeInventoryMetadataParam, metadata?: types.AuthorizeInventoryMetadataParam): Promise<FetchResponse<200, types.AuthorizeInventoryResponse200>> {
    return this.core.fetch('/{projectId}/authorize/inventory', 'post', body, metadata);
  }
   ...
   */
  metaInfo(metadata: types.MetaInfoMetadataParam): Promise<FetchResponse<200, types.MetaInfoResponse200>> {
   ...
   */
  metadataUpdate(body: types.MetadataUpdateBodyParam, metadata: types.MetadataUpdateMetadataParam): Promise<FetchResponse<200, types.MetadataUpdateResponse200>> {
    return this.core.fetch('/{projectId}/metadata/{tokenId}', 'put', body, metadata);
  }
   ...
   */
  imxRegister(body: types.ImxRegisterBodyParam, metadata: types.ImxRegisterMetadataParam): Promise<FetchResponse<200, types.ImxRegisterResponse200>> {
    return this.core.fetch('/{projectId}/imx/register', 'post', body, metadata);
  }
   ...
   */
  imxMint(body: types.ImxMintBodyParam, metadata: types.ImxMintMetadataParam): Promise<FetchResponse<201, types.ImxMintResponse201>>;
  imxMint(metadata: types.ImxMintMetadataParam): Promise<FetchResponse<201, types.ImxMintResponse201>>;
  imxMint(body?: types.ImxMintBodyParam | types.ImxMintMetadataParam, metadata?: types.ImxMintMetadataParam): Promise<FetchResponse<201, types.ImxMintResponse201>> {
   ...
   */
  imxTransfer(body: types.ImxTransferBodyParam, metadata: types.ImxTransferMetadataParam): Promise<FetchResponse<200, types.ImxTransferResponse200>> {
    return this.core.fetch('/{projectId}/imx/transfer', 'post', body, metadata);
  }
   ...
   */
  mintMint(body: types.MintMintBodyParam, metadata: types.MintMintMetadataParam): Promise<FetchResponse<201, types.MintMintResponse201>>;
  mintMint(metadata: types.MintMintMetadataParam): Promise<FetchResponse<201, types.MintMintResponse201>>;
  mintMint(body?: types.MintMintBodyParam | types.MintMintMetadataParam, metadata?: types.MintMintMetadataParam): Promise<FetchResponse<201, types.MintMintResponse201>> {
   ...
   */
  mintClaim(body: types.MintClaimBodyParam, metadata: types.MintClaimMetadataParam): Promise<FetchResponse<201, types.MintClaimResponse201>>;
  mintClaim(metadata: types.MintClaimMetadataParam): Promise<FetchResponse<201, types.MintClaimResponse201>>;
  mintClaim(body?: types.MintClaimBodyParam | types.MintClaimMetadataParam, metadata?: types.MintClaimMetadataParam): Promise<FetchResponse<201, types.MintClaimResponse201>> {
   ...
   */
  custodialWalletsCreate(body: types.CustodialWalletsCreateBodyParam): Promise<FetchResponse<201, types.CustodialWalletsCreateResponse201>> {
   ...
   */
  custodialWalletsRemove(body: types.CustodialWalletsRemoveBodyParam, metadata: types.CustodialWalletsRemoveMetadataParam): Promise<FetchResponse<200, types.CustodialWalletsRemoveResponse200>> {
    return this.core.fetch('/custodial-wallets/{walletAddress}', 'delete', body, metadata);
  }
   ...
   */
  custodialWalletsExportsRequest(body: types.CustodialWalletsExportsRequestBodyParam, metadata: types.CustodialWalletsExportsRequestMetadataParam): Promise<FetchResponse<200, types.CustodialWalletsExportsRequestResponse200>> {
    return this.core.fetch('/custodial-wallets/{walletAddress}/exports/request', 'post', body, metadata);
  }
   ...
   */
  custodialWalletsExportsApprove(body: types.CustodialWalletsExportsApproveBodyParam, metadata: types.CustodialWalletsExportsApproveMetadataParam): Promise<FetchResponse<200, types.CustodialWalletsExportsApproveResponse200>> {
    return this.core.fetch('/custodial-wallets/{walletAddress}/exports/approve', 'post', body, metadata);
  }
   ...
   */
  premintsList(metadata: types.PremintsListMetadataParam): Promise<FetchResponse<200, types.PremintsListResponse200>> {
   ...
   */
  premintsCreate(body: types.PremintsCreateBodyParam, metadata: types.PremintsCreateMetadataParam): Promise<FetchResponse<201, types.PremintsCreateResponse201>> {
   ...
   */
  premintsShow(metadata: types.PremintsShowMetadataParam): Promise<FetchResponse<200, types.PremintsShowResponse200>> {
    return this.core.fetch('/{projectId}/premints/{premintId}', 'get', metadata);
  }
   ...
   */
  premintsRemove(metadata: types.PremintsRemoveMetadataParam): Promise<FetchResponse<200, types.PremintsRemoveResponse200>> {
    return this.core.fetch('/{projectId}/premints/{premintId}', 'delete', metadata);
  }
   ...
   */
  premintsUpdate(body: types.PremintsUpdateBodyParam, metadata: types.PremintsUpdateMetadataParam): Promise<FetchResponse<200, types.PremintsUpdateResponse200>> {
    return this.core.fetch('/{projectId}/premints/{premintId}', 'put', body, metadata);
  }
   ...
   */
  premintsImport(body: types.PremintsImportBodyParam, metadata: types.PremintsImportMetadataParam): Promise<FetchResponse<200, types.PremintsImportResponse200>>;
  premintsImport(metadata: types.PremintsImportMetadataParam): Promise<FetchResponse<200, types.PremintsImportResponse200>>;
  premintsImport(body?: types.PremintsImportBodyParam | types.PremintsImportMetadataParam, metadata?: types.PremintsImportMetadataParam): Promise<FetchResponse<200, types.PremintsImportResponse200>> {
    return this.core.fetch('/{projectId}/premints/import', 'post', body, metadata);
  }
   ...
   */
  projectsCreate(body: types.ProjectsCreateBodyParam): Promise<FetchResponse<201, types.ProjectsCreateResponse201>> {
   ...
   */
  projectsShow(metadata: types.ProjectsShowMetadataParam): Promise<FetchResponse<200, types.ProjectsShowResponse200>> {
   ...
   */
  projectsUpdate(body: types.ProjectsUpdateBodyParam, metadata: types.ProjectsUpdateMetadataParam): Promise<FetchResponse<200, types.ProjectsUpdateResponse200>> {
   ...
   */
  projectsRemove(metadata: types.ProjectsRemoveMetadataParam): Promise<FetchResponse<200, types.ProjectsRemoveResponse200>> {
   ...
   */
  projectsMintUpdate(body: types.ProjectsMintUpdateBodyParam, metadata: types.ProjectsMintUpdateMetadataParam): Promise<FetchResponse<200, types.ProjectsMintUpdateResponse200>> {
    return this.core.fetch('/projects/{projectId}/mint', 'put', body, metadata);
  }
   ...
   */
  projectsClaimUpdate(body: types.ProjectsClaimUpdateBodyParam, metadata: types.ProjectsClaimUpdateMetadataParam): Promise<FetchResponse<200, types.ProjectsClaimUpdateResponse200>> {
    return this.core.fetch('/projects/{projectId}/claim', 'put', body, metadata);
  }
   ...
   */
  projectsDeploy(metadata: types.ProjectsDeployMetadataParam): Promise<FetchResponse<200, types.ProjectsDeployResponse200>> {
...
export type { AuthorizeBodyParam, AuthorizeInventoryBodyParam, AuthorizeInventoryMetadataParam, AuthorizeInventoryResponse200, AuthorizeInventoryResponse400, AuthorizeInventoryResponse422, AuthorizeMetadataParam, AuthorizeResponse200, AuthorizeResponse400, AuthorizeResponse422, CustodialWalletsCreateBodyParam, CustodialWalletsCreateResponse201, CustodialWalletsCreateResponse400, CustodialWalletsCreateResponse422, CustodialWalletsExportsApproveBodyParam, CustodialWalletsExportsApproveMetadataParam, CustodialWalletsExportsApproveResponse200, CustodialWalletsExportsApproveResponse400, CustodialWalletsExportsApproveResponse422, CustodialWalletsExportsRequestBodyParam, CustodialWalletsExportsRequestMetadataParam, CustodialWalletsExportsRequestResponse200, CustodialWalletsExportsRequestResponse400, CustodialWalletsExportsRequestResponse422, CustodialWalletsRemoveBodyParam, CustodialWalletsRemoveMetadataParam, CustodialWalletsRemoveResponse200, CustodialWalletsRemoveResponse400, CustodialWalletsRemoveResponse422, ImxMintBodyParam, ImxMintMetadataParam, ImxMintResponse201, ImxMintResponse400, ImxMintResponse422, ImxRegisterBodyParam, ImxRegisterMetadataParam, ImxRegisterResponse200, ImxRegisterResponse400, ImxRegisterResponse422, ImxTransferBodyParam, ImxTransferMetadataParam, ImxTransferResponse200, ImxTransferResponse400, ImxTransferResponse422, MetaInfoMetadataParam, MetaInfoResponse200, MetaInfoResponse400, MetaInfoResponse422, MetadataUpdateBodyParam, MetadataUpdateMetadataParam, MetadataUpdateResponse200, MetadataUpdateResponse400, MetadataUpdateResponse422, MintClaimBodyParam, MintClaimMetadataParam, MintClaimResponse201, MintClaimResponse400, MintClaimResponse422, MintMintBodyParam, MintMintMetadataParam, MintMintResponse201, MintMintResponse400, MintMintResponse422, PremintsCreateBodyParam, PremintsCreateMetadataParam, PremintsCreateResponse201, PremintsCreateResponse400, PremintsCreateResponse422, PremintsImportBodyParam, PremintsImportMetadataParam, PremintsImportResponse200, PremintsImportResponse400, PremintsImportResponse422, PremintsListMetadataParam, PremintsListResponse200, PremintsListResponse400, PremintsListResponse422, PremintsRemoveMetadataParam, PremintsRemoveResponse200, PremintsRemoveResponse400, PremintsRemoveResponse422, PremintsShowMetadataParam, PremintsShowResponse200, PremintsShowResponse400, PremintsShowResponse422, PremintsUpdateBodyParam, PremintsUpdateMetadataParam, PremintsUpdateResponse200, PremintsUpdateResponse400, PremintsUpdateResponse422, ProjectsClaimUpdateBodyParam, ProjectsClaimUpdateMetadataParam, ProjectsClaimUpdateResponse200, ProjectsClaimUpdateResponse400, ProjectsClaimUpdateResponse422, ProjectsCreateBodyParam, ProjectsCreateResponse201, ProjectsCreateResponse400, ProjectsCreateResponse422, ProjectsDeployMetadataParam, ProjectsDeployResponse200, ProjectsDeployResponse400, ProjectsDeployResponse422, ProjectsListResponse200, ProjectsListResponse400, ProjectsListResponse422, ProjectsMintUpdateBodyParam, ProjectsMintUpdateMetadataParam, ProjectsMintUpdateResponse200, ProjectsMintUpdateResponse400, ProjectsMintUpdateResponse422, ProjectsRemoveMetadataParam, ProjectsRemoveResponse200, ProjectsRemoveResponse400, ProjectsRemoveResponse422, ProjectsShowMetadataParam, ProjectsShowResponse200, ProjectsShowResponse400, ProjectsShowResponse422, ProjectsUpdateBodyParam, ProjectsUpdateMetadataParam, ProjectsUpdateResponse200, ProjectsUpdateResponse400, ProjectsUpdateResponse422 } from './types';
